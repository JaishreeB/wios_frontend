...
@Component({
  selector: 'header',
  imports: [RouterOutlet,RouterLink,RegistrationComponent,ZoneComponent,VendorComponent,StockComponent,TransactionComponent,MetricsComponent,DashboardComponent],
